                    ...
                    <div class="main_menu_area">
                        ...
                        <ul class="menu_item">
                            ...
                            <li>
                                ...
                                <ul class="menu_droapdown">
                                    <li><a href="diagnostic_equipment.html">Diagnostic Equipment</a></li>
                                    <li><a href="therapeutic_equipment.html">Therapeutic Equipment</a></li>
                                    <li><a href="surgical_instruments.html">Surgical Instruments</a></li>
                                    <li><a href="hospital_furniture.html">Hospital Furniture</a></li>
                                    <li><a href="consumables.html">Consumables & Supplies</a></li>
                                    <li><a href="featured_products.html">New Arrivals</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="menu_droapdown">
                                    <li><a href="after_sales.html">After-Sales Support</a></li>
                                    <li><a href="installation_training.html">Installation & Training</a></li>
                                    <li><a href="consultation.html">Consultation & Procurement</a></li>
                                    <li><a href="warranty.html">Warranty & Guarantee</a></li>
                                </ul>
                            </li>

                            <li>
                                <a href="#">Insights <i class="fas fa-chevron-down"></i></a>
                                <ul class="menu_droapdown">
                        ...
                        <ul class="menu_icon">
                            ...
                            <li>
                                <a class="user" href="dashboard.html">
                                    <b>
                                        <img src="assets/images/user_icon_black.svg" alt="cart"
                                            class="img-fluid">
                                    </b>
                                    <h5> Smith Jhon</h5>
                                </a>
